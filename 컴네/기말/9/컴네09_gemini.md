...
* **정의**: 내부 네트워크의 **사설 IP(Private IP)** 주소(예: `10.0.0.1`)를 **공인 IP(Public IP)** 주소(예: `138.76.29.7`)로 변환하는 라우터의 기술입니다. 
...
1.  **[내부 → 외부]**
    ...
    * 이 변환 규칙(`(10.0.0.1:3345) ↔ (138.76.29.7:5001)`)을 **NAT 변환 테이블**에 저장합니다. 
2.  **[외부 → 내부]**
