안녕하세요! 컴퓨터 네트워크 7주차 강의인 'TCP/UDP 비교 및 혼잡 제어' PDF 파일의 전체 내용을 요청하셨습니다.
...
# 🖥️ 컴퓨터네트워크: 7주차 TCP/UDP 비교 (혼잡 제어)



이번 7주차 강의는 **전송 계층(Transport Layer)**의 핵심 프로토콜인 **UDP**와 **TCP**, 그리고 TCP의 가장 중요한 기능인 **혼잡 제어(Congestion Control)**에 대해 자세히 다룹니다. 
